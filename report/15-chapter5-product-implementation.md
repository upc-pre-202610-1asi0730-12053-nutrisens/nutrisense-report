...
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-platform | feature/migration-resx | `81c151d` | refactor(shared): relocate SharedResource to Shared/Resources and trim BC messages | Move SharedResource into the Shared/Resources namespace, remove the legacy Resources/ copies, and drop bounded-context-specific strings now owned by each BC. | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-platform | feature/migration-resx | `41d56ef` | refactor(iam): use per-context IAMMessages resources | Add IAM/Resources/IAMMessages and point IAM controllers and result assemblers at it. | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-platform | feature/migration-resx | `74b6bdd` | refactor(body-health-metrics): use per-context BodyHealthMetricsMessages resources | — | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-platform | feature/migration-resx | `ff1b594` | refactor(nutrition-tracking): use per-context NutritionTrackingMessages resources | — | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-platform | feature/migration-resx | `e024cc4` | refactor(activity-wearable): use per-context ActivityWearableMessages resources | — | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-platform | feature/migration-resx | `a8e73c3` | refactor(analytics-reporting): use per-context AnalyticsReportingMessages resources | — | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-platform | feature/migration-resx | `cec20fb` | refactor(smart-recommendations): use per-context SmartRecommendationsMessages resources | — | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-platform | develop | `d136ae3` | Merge pull request #19 from upc-pre-202610-1asi0730-12053-nutrisens/feature/migration-resx | Feature/migration resx | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-platform | main | `d48cb37` | Merge pull request #20 from upc-pre-202610-1asi0730-12053-nutrisens/develop | release/1.1.0 | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-webapp | feature/i18n-error-handling | `867a295` | feat(shared): surface localized backend error messages | Add backendMessage() helper to extract the backend-provided error message and send Accept-Language so the API can localize responses. | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-webapp | feature/i18n-error-handling | `1408dcc` | feat(iam): strengthen registration and onboarding validation | Require a letter in passwords, detect 409 conflicts on register, and make the waist measurement method mandatory in onboarding, with EN/ES strings and localized backend error fallbacks. | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-webapp | feature/i18n-error-handling | `b271b78` | feat(views): show localized backend error messages | Adopt backendMessage() across activity, analytics, body, nutrition, recommendations, billing and profile views so toasts and error banners prefer the API's localized message over the generic fallback. | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-webapp | develop | `ed26afb` | Merge pull request #22 from upc-pre-202610-1asi0730-12053-nutrisens/feature/i18n-error-handling | Feature/i18n error handling | 21/06/2026 |
| upc-pre-202610-1asi0730-12053-nutrisens/nutrisense-webapp | main | `e1a04d8` | Merge pull request #23 from upc-pre-202610-1asi0730-12053-nutrisens/develop | release/2.0.1 | 21/06/2026 |
